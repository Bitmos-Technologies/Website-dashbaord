...
export default function RestaurantsPage() {
  return (
    <PublicPageShell eyebrow="Restaurants" title="Featured restaurants available on BiteNow." description="Static restaurant cards for browsing and navigation wireframe testing.">
