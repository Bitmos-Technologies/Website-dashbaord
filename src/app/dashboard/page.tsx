...
export default function Dashboard() {
  return <>
      <header className="dash-topbar"><div><h1>Good morning, Sarah</h1><p>Here&apos;s what&apos;s happening at Luma today.</p></div><div className="top-actions"><button className="icon-btn"><Bell size={17}/></button><button className="new-order"><Plus size={15}/> New order</button></div></header>
