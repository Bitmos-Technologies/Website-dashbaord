...
export const hotels = rows([
  {id:"HTL-01",name:"Luma Nairobi",location:"Westlands, Nairobi",phone:"+254 700 123 456",email:"hello@luma.co.ke",status:"Active",created:"05 Jan 2026"},{id:"HTL-02",name:"Luma Coast",location:"Nyali, Mombasa",phone:"+254 711 230 987",email:"coast@luma.co.ke",status:"Active",created:"17 Feb 2026"},{id:"HTL-03",name:"The Luma Lodge",location:"Nanyuki, Laikipia",phone:"+254 722 481 002",email:"lodge@luma.co.ke",status:"Inactive",created:"09 Mar 2026"},
]);
export const memberships = rows([
  {id:"MEM-101",name:"Sarah Kimani",email:"sarah@luma.co.ke",role:"Manager",hotel:"Luma Nairobi",status:"Active",joined:"08 Jan 2026"},{id:"MEM-102",name:"David Otieno",email:"david@luma.co.ke",role:"Kitchen Staff",hotel:"Luma Nairobi",status:"Active",joined:"12 Jan 2026"},{id:"MEM-103",name:"Grace Wanjiku",email:"grace@luma.co.ke",role:"Cashier",hotel:"Luma Coast",status:"Active",joined:"02 Mar 2026"},{id:"MEM-104",name:"Peter Ali",email:"peter@luma.co.ke",role:"Waiter",hotel:"Luma Coast",status:"Inactive",joined:"14 Mar 2026"},
]);
